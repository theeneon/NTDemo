  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        description="Every ninja brings a distinct tactical role. Review the team now; progression data and live combat arrive in later phases."
        action={
            ...
            return (
              ...
              >
                ...
                <div className="ninja-stats">
                  <span>
                    <small>Level</small>
                    <strong>{ninja.level}</strong>
                  </span>
                  <span>
                    <small>Power</small>
                    <strong>{ninja.power}</strong>
                  </span>
                </div>
                <Link
